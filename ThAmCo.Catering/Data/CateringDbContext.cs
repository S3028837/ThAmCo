    ...
    public class CateringDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FoodItem>().HasData(
                new FoodItem { FoodItemId = 1, Description = "Pizza" },
                new FoodItem { FoodItemId = 2, Description = "Burger" },
                new FoodItem { FoodItemId = 3, Description = "Pasta" },
                new FoodItem { FoodItemId = 4, Description = "Salad" },
                new FoodItem { FoodItemId = 5, Description = "Sushi" },
                new FoodItem { FoodItemId = 6, Description = "Steak" },
                new FoodItem { FoodItemId = 7, Description = "Tacos" },
                new FoodItem { FoodItemId = 8, Description = "Ice Cream" }
            );
